...
const archiveData: Record<string, ProjectRecord> = {
    ...
    'ea-42': {
        ...
        galleryImages: [
            '/site-static/eataly/eataly_04.webp',
            '/site-static/eataly/eataly_05.webp',
            '/site-static/eataly/eataly_06.webp',
            '/site-static/eataly/eataly_07.webp'
        ],
    ...
    'pn-88': {
        ...
        galleryImages: [
            '/site-static/puno/puno_04.webp',
            '/site-static/puno/puno_05.webp',
            '/site-static/puno/puno_06.webp',
            '/site-static/puno/puno_07.webp',
            '/site-static/puno/puno_08.webp',
            '/site-static/puno/puno_09.webp',
            '/site-static/puno/puno_10.webp'
        ],
    ...
    'lr-11': {
        ...
        galleryImages: [
            '/site-static/laradice/laradice_04.webp'
        ],
