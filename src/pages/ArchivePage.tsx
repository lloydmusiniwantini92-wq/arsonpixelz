...
const archiveData: Record<string, ProjectRecord> = {
    'tt-01': {
        ...
        bio: 'Tony Thompson is the human-led missing piece for high-stakes venture failures. Deconstructed facilitation process for C-Suite dominance.',
        voidText: 'THE PROBLEM: INVISIBLE IMPACT. Tony\'s offline successes saving manufacturing timelines were invisible. His vision was trapped in a generic existence.',
        chaosText: 'THE EXECUTION: SYSTEMATIC INTENSITY. We built a structured environment mirroring Tony\'s facilitation. An archive of 300+ evaluated causes and architectural artifacts.',
        ...
        heroSlogan: 'INDUSTRIAL LEADERSHIP. ARCHIVE AS PROTOCOL.',
    },
    'ea-42': {
        id: 'ea-42',
        title: 'EATALY',
        ...
        bio: 'Synthesizing heritage with the digital frontier. A total architectural reconstruction of the Eataly shopping experience via tactile interface.',
        voidText: 'THE PROBLEM: PHYSICAL FRAGMENTATION. Eataly\'s global retail lacked sensory intensity online. The goal: translate "Taste" into "Interface".',
        chaosText: 'THE EXECUTION: CULINARY ARCHITECTURE. We replaced the generic "Add to Cart" with a high-stakes artifact acquisition system mirroring a Milanese market.',
        ...
        heroSlogan: 'SYNTHESIZING HERITAGE. RECONSTRUCTING RETAIL.',
    },
    'pn-88': {
        id: 'pn-88',
        title: 'PUNO',
    ...
    'lr-11': {
        ...
        bio: 'Digitizing structured furniture architecture into visually responsive design signals. Translating pure artisanal values into physical resonance.',
        voidText: 'THE PROBLEM: MASS-PRODUCED NOISE. Furniture has lost its structural soul to global scaling. La Radice needed to showcase single-joint intensity.',
        chaosText: 'THE EXECUTION: MATERIAL_HIERARCHY. We engineered a spatial environment treating every piece as a monument. An architectural archive of physical structure.',
        ...
        heroSlogan: 'STRUCTURAL SOUL. ORGANIC MATERIALITY.',
    },
    'or-07': {
        id: 'or-07',
        title: 'ORBIT',
        ...
        bio: 'A generative spatial environment powered by neural networks. Redefining boundaries between physical structures and digital interfaces via algorithmic design.',
        voidText: 'ORBIT IS A LIVING SYSTEM. EVERY INTERACTION TRAINS THE NEXT ITERATION. THE INTERFACE EVOLVES WITH EACH USE.',
        chaosText: 'WE STOPPED DESIGNING SCREENS AND STARTED DESIGNING BEHAVIORS. AN ENVIRONMENT THAT ANTICIPATES YOUR PRESENCE BEFORE YOU ARRIVE.',
        ...
        heroSlogan: 'BEYOND STRATOSPHERE. INTERPLANETARY LOGISTICS.',
    },
    'nx-99': {
        id: 'nx-99',
        title: 'NEXUS',
        ...
        bio: 'Digitizing structured architecture into visually responsive design signals. Translating pure branding into frequency dynamics.',
        voidText: 'WE ENGINEER SIGNALS. NEXUS IS THE PLATFORM THAT CONVERTS ABSTRACT BRAND VALUES INTO MEASURABLE RESONANCE.',
        chaosText: 'EVERY BRAND HAS A FREQUENCY. WE BUILT A SYSTEM TO LOCATE, AMPLIFY, AND BROADCAST IT AT SCALE. A PURE TRANSMISSION.',
        ...
        deliverables: ['Signal Identity Architecture', 'Multi-Platform Brand Systems', 'Frequency Analytics', 'Visual Language Protocol'],
        coordinates: '51.5074_N_0.1278_W',
        heroSlogan: 'IDENTITY AS FREQUENCY. BRAND AS SIGNAL.',
    },
};
